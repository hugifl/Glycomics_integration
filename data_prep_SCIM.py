...
OUTIDR = Path('/cluster/scratch/hugifl/9_glycomics_7')
...
no_gex = True 
only_markers = False   # if True, only the marker genes are used, if False, marker genes + highly variable genes are used
scaling = False
log = False
percentile = 10
